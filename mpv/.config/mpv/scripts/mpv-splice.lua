...
-- mp.add_key_binding('p', "show_times", show_times)
mp.add_key_binding('C', "process_video", process_video)
mp.add_key_binding('D', "reset_current_slice", reset_current_slice)
-- mp.add_key_binding('Alt+d', "delete_slice", delete_slice)
